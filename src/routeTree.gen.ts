...
import { Route as ApiGradingRouteImport } from './routes/api/grading'
...
const ApiGradingRoute = ApiGradingRouteImport.update({
  id: '/api/grading',
  path: '/api/grading',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/grading': typeof ApiGradingRoute
...
export interface RootRouteChildren {
  ...
  ApiGradingRoute: typeof ApiGradingRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/grading': {
      id: '/api/grading'
      path: '/api/grading'
      fullPath: '/api/grading'
      preLoaderRoute: typeof ApiGradingRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/search': {
      id: '/api/search'
